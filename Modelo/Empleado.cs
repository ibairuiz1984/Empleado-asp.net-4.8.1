...
namespace web_umg_bd
{
    public class Empleado
    {
        ...
        {
            int no_ingreso = 0;
            if (!string.IsNullOrEmpty(codigo) && !string.IsNullOrEmpty(nombres) && !string.IsNullOrEmpty(apellidos) && !string.IsNullOrEmpty(direccion) && !string.IsNullOrEmpty(telefono) && !string.IsNullOrEmpty(fecha))
            {
                conectar = new ConexionBD();
                conectar.AbrirConexion();
